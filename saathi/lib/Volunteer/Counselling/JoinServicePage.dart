...
class JoinServiceCounselling extends StatefulWidget {
  const JoinServiceCounselling({super.key});

  @override
  State<JoinServiceCounselling> createState() => _JoinServiceCounsellingState();
}

class _JoinServiceCounsellingState extends State<JoinServiceCounselling> {
  join() async {
