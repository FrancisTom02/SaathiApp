...
class HomeNursingDetails extends StatefulWidget {
  const HomeNursingDetails({super.key});

  @override
  State<HomeNursingDetails> createState() => _HomeNursingDetailsState();
}

class _HomeNursingDetailsState extends State<HomeNursingDetails> {
  @override
