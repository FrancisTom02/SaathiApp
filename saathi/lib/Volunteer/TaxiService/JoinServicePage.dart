...
import 'package:saathi/Volunteer/TaxiService/ServiceDetails.dart';
import 'package:saathi/Volunteer/Volunteer_HomePage1.dart';
import 'package:stroke_text/stroke_text.dart';

class JoinServiceTaxiService extends StatefulWidget {
  const JoinServiceTaxiService({super.key});

  @override
  State<JoinServiceTaxiService> createState() => _JoinServiceTaxiServiceState();
}

class _JoinServiceTaxiServiceState extends State<JoinServiceTaxiService> {
  join() async {
