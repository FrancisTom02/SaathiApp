...
class TaxiServiceDetails extends StatefulWidget {
  const TaxiServiceDetails({super.key});

  @override
  State<TaxiServiceDetails> createState() => _TaxiServiceDetailsState();
}

class _TaxiServiceDetailsState extends State<TaxiServiceDetails> {
  @override
