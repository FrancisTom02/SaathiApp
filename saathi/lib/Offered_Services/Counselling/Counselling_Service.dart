...
import '../Consultancy/Consultancy_Service2.dart';

class Service_Counselling extends StatelessWidget {
  const Service_Counselling({super.key});
            ...
            Expanded(
              child: FutureBuilder(
                future: FirebaseFirestore.instance
                    ...
                    .where('counselling', isEqualTo: 'true')
                    .get(),
